    ...
    <header className="flex justify-between items-center px-6 py-4 sm:px-8 md:px-12 md:py-6 max-w-screen-2xl mx-auto">
      ...
      <div className="flex flex-row-reverse sm:flex-row items-center justify-end gap-4 sm:gap-6">
        <div
          ...
          } z-10 flex flex-col fixed pt-20 sm:pt-0 pl-8 sm:pl-0 top-0 bottom-0 h-screen sm:h-auto right-0 w-48 sm:w-auto bg-indigo-500 sm:static sm:bg-transparent gap-4 sm:gap-8 sm:translate-x-0 sm:flex-row`}
        >
          {links.map((link) => (
