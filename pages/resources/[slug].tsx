...
const Ide: NextPage = (props: any) => {
  ...
  return (
    <>
      ...
      />
      <main className="bg-slate-50 pb-12 lg:pb-20 pt-20">
        <article className="!max-w-screen-lg mx-auto px-4 mt-8 lg:px-0 prose lg:prose-lg prose-headings:!mt-8 prose-headings:!my-4 prose-headings:text-indigo-500 prose-h1:!text-[32px] lg:prose-h1:!text-[40px] prose-a:text-indigo-500 hover:prose-a:text-indigo-700 prose-strong:!text-slate-700">
